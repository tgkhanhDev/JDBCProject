...
<html lang="en">
    ...
    <head>
        ...
        <!--             <link rel="stylesheet" href="/PrjProject/page/mainPageSighIn/stylenavbar.css"/>-->
    </head>

    <body class="max-w-[var(--maxWidth)] w-[95vw] m-auto overflow-x-hidden transition-all ease-in-out duration-500">
        <!-- navbar  ------>
        <%
            //lay data login user do loginController tao ra trong session data !! luu  y
            ...
            <div class="absolute w-screen flex justify-center">
                ...
                <div class="sub-menu-wrap " id="subMenu">
                    <div class="sub-menu" >
                        ...
                        <!-- client only --> <%if (acc.getRoleName().equalsIgnoreCase("Client")) { %>
                        <a class="sub-menu-link" href="#">
                        ...
                        <a class="sub-menu-link" href="#">
                            <img src="/PrjProject/img/navbarSignin/device.png" alt="">
                        ...
                        <hr>
                            <!-- admin only -->
                        <% if (acc.getRoleName().equalsIgnoreCase("Admin")) { %>
