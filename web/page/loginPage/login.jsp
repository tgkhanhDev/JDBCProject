                    ...
                    <div class="flex flex-col gap-7 w-full text-white z-[1]">
                        ...
                        <form action="mainController" method="post">
                            ...
                            <div class="w-[70%] m-auto">
                                ...
                                <input type="text" class="text-black w-full m-auto rounded-xl"  name="txtgmail" placeholder="enter gmail" required=""/>
                            </div>
                            <div class="w-[70%] m-auto">
                                <div class="">Password:</div>
                                <input type="password" class="text-black w-full m-auto rounded-xl" name="txtpass" placeholder="enter password" required=""/>
                        ...
                        <div class="flex flex-col gap-7 my-2 w-[90%] m-auto">
                            ...
                            <form action="mainController" method="post">
                                ...
                                <div class="lg:w-[70%] m-auto">
                                    ...
                                    <input type="text" class="text-black w-full m-auto rounded-xl" name="txtphone" placeholder="enter numberphone" required=""/>
                                </div>
                                <div class="lg:w-[70%] m-auto">
                                    <div class="">Gmail:</div>
                                    <input type="text" class="text-black w-full m-auto rounded-xl" name="txtgmail" placeholder="enter gmail" required=""/>
                                ...
                                <div class="lg:w-[70%] m-auto">
                                    ...
                                    <input type="password" class="text-black w-full m-auto rounded-xl" name="txtpassagain" placeholder="enter password" required=""/>
                                    <div class="w-full flex justify-end"> 
                                        <%
